exports.swarm = function(number_of_swarms, bots_per_swarm, arena_size, three_bodies, swarm) {
  const { hsl_to_rgb } = require('file::@@:Base:ui/hsl_to_rgb.js');
  const { body_generator } = require('file::@@:Base:robots/vybot_alpha.js');
  const { botstate_init } = require('file::@@:Base:robots/vybot_alpha_statev.js');
  var bot_specs = {
    track_width:0.3,
    wheel_base:0.6,
    height:0.1,
