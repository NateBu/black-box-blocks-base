...
var get_dataset_index = function(chart, label, fill) {
...
var add_data = function(chart, setlabel, dataid, datalabel, fill, data) {
...
line_chart = function(chart_label, x_, ylist, db) {
